...
files_to_load = "paragraph_1.txt"
files_to_output = "paragraph_1.txt"
...
# Loop throught the word array and calculate the length of each word
...
#  Loop through the sentence array and calculate the number of words in each sentence
